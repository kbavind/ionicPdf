...
const Modal = class {
  ...
  initSwipeToClose() {
    ...
    this.gesture = createSwipeToCloseGesture(this.el, ani, () => {
      ...
      this.animation.onFinish( /*#__PURE__*/(0,D_Workplace_ionicPdf_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
